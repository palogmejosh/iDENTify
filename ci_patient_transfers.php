...
<body class="bg-gradient-to-br from-violet-25 via-white to-purple-25 dark:bg-black transition-colors duration-200">
    ...
    <!-- Main Content -->
    <main
        class="ml-64 mt-[64px] min-h-screen bg-gradient-to-br from-violet-50 to-purple-50 dark:bg-black p-6 overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
            <h2
                ...
                Patient Transfer Management</h2>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                        You can transfer your assigned patients to other Clinical Instructors regardless of their
                        approval status. When you send a transfer request, the receiving instructor can accept or reject
                        it. You can view incoming requests and respond to them here.
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Tabs -->
        <div
            class="bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6 border border-violet-200 dark:border-violet-700">
            <div class="flex border-b border-gray-200 dark:border-gray-700">
                <button onclick="switchTab('incoming')" id="incomingTab"
                    class="tab-button tab-active px-6 py-3 text-sm font-medium focus:outline-none">
                    Incoming Requests
                    <?php if ($transferCounts['incoming_pending'] > 0): ?>
                        <span
                            class="ml-2 bg-red-500 text-white text-xs rounded-full px-2 py-1"><?php echo $transferCounts['incoming_pending']; ?></span>
                    <?php endif; ?>
                </button>
                <button onclick="switchTab('outgoing')" id="outgoingTab"
                    class="tab-button px-6 py-3 text-sm font-medium focus:outline-none">
                    Outgoing Requests
                    <?php if ($transferCounts['outgoing_pending'] > 0): ?>
                        <span
                            class="ml-2 bg-yellow-500 text-white text-xs rounded-full px-2 py-1"><?php echo $transferCounts['outgoing_pending']; ?></span>
                    <?php endif; ?>
                </button>
            ...
            <div id="incomingContent" class="tab-content p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Pending Incoming Transfer Requests
                    </h3>
                    <button onclick="toggleFilters('incoming')"
                        class="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 flex items-center">
                ...
                <div id="incomingFilters" class="mb-4 hidden">
                    <div
                        class="bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 border border-violet-200 dark:border-violet-700 rounded-lg p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Search
                                    Patient</label>
                        ...
                        <div class="mt-3 flex justify-end">
                            <button onclick="clearIncomingFilters()"
                                ...
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                            <i class="ri-user-line mr-1"></i>From:
                                            <?php echo htmlspecialchars($transfer['from_ci_name']); ?>
                                        </p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <?php if (!empty($transfer['treatment_hint'])): ?>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                                <i class="ri-medicine-bottle-line mr-1"></i>Procedure Details:
                                                <?php echo htmlspecialchars($transfer['treatment_hint']); ?>
                                            </p>
                                        <?php endif; ?>
                                    ...
                                    <div class="flex flex-col space-y-2 ml-4">
                                        <button
                                            onclick="openIncomingDetailsModal(<?php echo htmlspecialchars(json_encode($transfer)); ?>)"
                                        ...
                                        <button
                                            onclick="openResponseModal(<?php echo htmlspecialchars(json_encode($transfer)); ?>, 'accept')"
                                        ...
                                        <button
                                            onclick="openResponseModal(<?php echo htmlspecialchars(json_encode($transfer)); ?>, 'reject')"
            ...
            <div id="outgoingContent" class="tab-content p-6 hidden">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Pending Outgoing Transfer Requests
                    </h3>
                    <button onclick="toggleFilters('outgoing')"
                        class="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 flex items-center">
                        <i class="ri-filter-3-line mr-1"></i>Filters
                    </button>
                </div>
                ...
                <div id="outgoingFilters" class="mb-4 hidden">
                    <div
                        class="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Search
                                    Patient</label>
                        ...
                        <div class="mt-3 flex justify-end">
                            <button onclick="clearOutgoingFilters()"
                                class="text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">
                                <i class="ri-refresh-line mr-1"></i>Clear Filters
                            </button>
                        </div>
                            ...
                            <div class="outgoing-transfer-item bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4"
                                ...
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                            <i class="ri-user-line mr-1"></i>To:
                                            <?php echo htmlspecialchars($transfer['to_ci_name']); ?>
                                        </p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                            <i class="ri-mail-line mr-1"></i><?php echo htmlspecialchars($transfer['email']); ?>
                                        </p>
                                    ...
                                    <div class="flex flex-col space-y-2 ml-4">
                                        <button
                                            onclick="openOutgoingDetailsModal(<?php echo htmlspecialchars(json_encode($transfer)); ?>)"
                                            class="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-4 py-2 rounded-md text-sm shadow-lg transition-all duration-200">
                                            <i class="ri-eye-line mr-1"></i>View Details
                                        </button>
            ...
            <div id="historyContent" class="tab-content p-6 hidden">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="toggleFilters('history')"
                        class="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 flex items-center">
                        <i class="ri-filter-3-line mr-1"></i>Filters
                    </button>
                </div>
                ...
                <div id="historyFilters" class="mb-4 hidden">
                    <div
                        class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
    ...
    <div id="responseModal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center px-4 z-50">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg mx-auto modal-fade">
            <div class="flex justify-between items-center mb-4">
                <h3 id="responseModalTitle" class="text-lg font-semibold text-gray-900 dark:text-white">Respond to
                    Transfer Request</h3>
    ...
    <!-- Incoming Request Details Modal -->
    <div id="incomingDetailsModal"
        class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center px-4 z-50">
        <div
            class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-2xl mx-auto modal-fade max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    <i class="ri-download-line mr-2"></i>Incoming Transfer Request Details
                </h3>
                <button onclick="closeIncomingDetailsModal()"
                    class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <i class="ri-close-line text-xl"></i>
                </button>
            </div>
    ...
    <div id="outgoingDetailsModal"
        ...
        <div
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="closeOutgoingDetailsModal()"
                    class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <i class="ri-close-line text-xl"></i>
                </button>
            </div>
    ...
    <div id="historyDetailsModal"
        ...
        <div
            class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-2xl mx-auto modal-fade max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
                <h3 id="historyModalTitle" class="text-lg font-semibold text-gray-900 dark:text-white">Transfer Details
                </h3>
